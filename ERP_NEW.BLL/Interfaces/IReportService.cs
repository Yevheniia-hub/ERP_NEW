...
namespace ERP_NEW.BLL.Interfaces
{
    public interface IReportService
    {
        ...
        bool ExpendituresForProject(List<ExpendituresStoreHousesDTO> source, DateTime startDate, DateTime endDate);
        bool ExpendituresForProjectWithTotalPrice(List<ExpendituresStoreHousesDTO> source, DateTime startDate, DateTime endDate, bool materialPrint);
        ...
        void FixedAssetsDecreeInput(FixedAssetsOrderRegJournalDTO model, FixedAssetsMaterialsDTO modelMaterials);
